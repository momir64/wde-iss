...
VALUES
    ...
    ('47c5fa7c-0d12-48e2-a4ed-9e4f441b383f', '91c1e927-9f79-44f4-b12f-bcbf16b16c6f', '456 Oak Ave', 'Beograd', 'Mark', 'Jones', '+1 323-555-5678'),
    ...
    ('1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236', '0cd13f4e-f7de-4533-9071-c42b7b3b4d45', '321 Elm Blvd', 'Beograd', 'Tom', 'Williams', '+1 415-555-1122');

INSERT INTO seller (id, profile_id, address, city, name, surname, telephone_number)
VALUES
    ('2b0cba7e-f6b9-4b28-9b92-48d5abfae6e5', 'e852c4ff-3d2b-47ea-b1fd-e711cf18b1d7', '987 Maple Dr', 'Beograd', 'Emily', 'Davis', '+1 206-555-3141'),
    ...
    ('c5e2a004-83b0-4f91-9ff2-c235f2166b72', '8bc76c7b-fc9d-469b-a7b1-2d2291d9a9b6', '543 Pinehill St', 'Beograd', 'Samuel', 'Jackson', '+1 512-555-3746');
...
VALUES
    ...
    ('ca97b729-3035-4170-b5f7-83f1e63e9b8a', 1, false, true, true,  true, 'Firework Shells', 1200.00, 0.15, 'Large shells that explode into a colorful burst in the sky, perfect for grand displays.'),
    ...
    ('ef58edcf-2fe7-4595-bdf6-9ef029ff4a98', 1, true, true,  true, false, 'BBQ Buffet', 1800.00, 0.15, 'A selection of grilled meats, sides, and sauces, perfect for outdoor events.'),
    ...
    ('72dbf31f-e7bb-43d5-890d-bde5c83ef03e', 1, true, true,  true, false, 'Sushi Rolls & Nigiri Platter', 1200.00, 0.15, 'A selection of fresh sushi rolls and nigiri, ideal for upscale events.'),
    ...
    ('b42d2a1a-b118-49ea-b83a-b1aee1b67e2e', 1, true, false, true,  false, 'Fresh Seafood Platter', 1300.00, 0.2, 'A selection of fresh seafood, perfect for luxury events or seafood lovers.'),
    ...
    ('9ea67f4b-50fd-4b4b-b0cc-693e35d5dbb5', 1, true, true,  true, true, 'Dessert Buffet', 1500.00, 0.25, 'A delightful variety of sweet treats, perfect for ending a meal on a high note.'),
    ...
    ('6a9cd799-4de1-4d3f-a70e-70f5157029b3', 1, true, true,  true, false, 'LED Wall Washers', 1200.00, 0.2, 'LED lights that wash walls with vibrant colors, perfect for large venues or stages.'),
    ('8c829577-d7d1-4ea5-b983-e21a41307947', 1, true, true,  true, false, 'Outdoor Flood Lights', 3500.00, 0.0, 'Powerful floodlights for illuminating outdoor spaces during events.'),
    ...
    -- STAGE & TENTS CATEGORY
    ('7e9d4ad7-b82c-43b5-9a4c-9e343f038779', 1, false, true, true,  false, 'Stage Setup (Small)', 1500.00, 0.1, 'Compact stage setup, perfect for smaller performances or presentations.'),
    ('e1c82607-b99a-41c4-8cd0-e09e4cc9f93d', 1, true, true, true, true, 'Outdoor Canopy Tent', 1200.00, 0.05, 'A spacious and durable outdoor canopy tent, perfect for outdoor events and gatherings.'),
    ('ac53c13a-d9cf-46b4-bdf9-3f9a4477e1ed', 1, true, true, true, false, 'Portable Stage for Events', 2200.00, 0.1, 'A compact, portable stage setup ideal for events that require mobility and ease of installation.'),
    ('9f0d0870-1f5c-4067-b2f5-fb22a2fe03e3', 1, true, true, true, false, 'Event Tent (Large)', 3000.00, 0.2, 'A large event tent that offers ample space for conferences, parties, and festivals.'),
...
VALUES
    ...
    ('0792d0dd-044d-43df-8031-5f9377522502', 1, 25, 'Event security for corporate conferences and expos, providing entry control, monitoring, and incident response.', 600, true, true, true, false, false, 'Corporate Event Security', 2500, 15, 0.0),
