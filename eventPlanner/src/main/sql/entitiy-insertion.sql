...
-- PROFILE
INSERT INTO profile (id, are_notifications_muted, email, is_active, is_verified, password,role_id)
VALUES
    -- PROFILES OF ADMINS
    ('7a92c4d7-8742-4a25-aee8-750ca987b42e', true, 'john.doe@example.com', true, true, '123','7ed06959-1018-406f-b3c1-2e91c08daa07'),
    ('b2d2e1f0-06ae-4b0f-9cd0-7b5b31b1e9fe', false, 'alice.lee@example.com', true, true, '123','7ed06959-1018-406f-b3c1-2e91c08daa07'),

    -- PROFILES OF EVENT ORGANIZERS
    ('3d82e9b8-3d9b-4c7d-b244-1e6725b78456', false, 'jane.smith@example.com', true, true, '123','6e569715-d341-4431-8370-d7516907d2e2'),
    ('91c1e927-9f79-44f4-b12f-bcbf16b16c6f', true, 'mark.jones@example.com', true, true, '123','6e569715-d341-4431-8370-d7516907d2e2'),
    ('a91f3db9-b5fe-4a7f-9d3f-299ab6164b2e', false, 'susan.brown@example.com', true, true, '123','6e569715-d341-4431-8370-d7516907d2e2'),
    ('0cd13f4e-f7de-4533-9071-c42b7b3b4d45', true, 'tom.williams@example.com', true, true, '1233','6e569715-d341-4431-8370-d7516907d2e2'),

    -- PROFILES OF SELLERS
    ('e852c4ff-3d2b-47ea-b1fd-e711cf18b1d7', false, 'emily.davis@example.com', true, true, '123','4e3484cf-382f-448d-a1db-1c1063ab41ee'),
    ('fddde66f-9b84-4bb8-b408-eae5b815ae69', true, 'robert.martin@example.com', true, true, '123','4e3484cf-382f-448d-a1db-1c1063ab41ee'),
    ('db48e7ac-1d35-4d9d-8e09-bf2e86533b91', false, 'lily.martinez@example.com', true, true, '123','4e3484cf-382f-448d-a1db-1c1063ab41ee'),
    ('8bc76c7b-fc9d-469b-a7b1-2d2291d9a9b6', true, 'samuel.jackson@example.com', true, true, '123','4e3484cf-382f-448d-a1db-1c1063ab41ee'),

    -- PROFILES OF GUESTS
    ('9a4531e5-2fda-42bc-8355-d7991bfc8ff4', true, 'john.smith@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('0d1f5f7a-6fcf-42d9-82fe-0090a35ea88c', false, 'grace.perez@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('679eb520-7b8d-4c3a-b99f-720e6cfb759b', true, 'oliver.harris@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('4d7248cb-d5f2-4e9b-9eb2-b8ad1de05bcf', false, 'mia.rodriguez@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('27e8a1b2-4d23-4b6f-b5a5-79a76d6b758e', true, 'jason.wilson@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('542c3a1b-ffea-421d-b967-7d45968c6506', false, 'sophia.morris@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('05fdc5be-d59b-468e-8466-d951a4a8d457', true, 'daniel.clark@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('03b88b74-0797-4f35-b15f-ff2a3c3e5c88', false, 'isabella.wright@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('70c7425e-c5f0-44f0-9e9d-44e4087fce62', true, 'ethan.king@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0'),
    ('5a72482a-cd36-46e4-8c09-7b2ff1e22071', false, 'madison.green@example.com', true, true, '123','9150703f-0449-40e1-b1fb-f0cb0a31b7b0');
...
VALUES
    ('2b0cba7e-f6b9-4b28-9b92-48d5abfae6e5', 'e852c4ff-3d2b-47ea-b1fd-e711cf18b1d7', '987 Maple Dr', 'Niš', 'Emily', 'Davis', '+1 206-555-3141'),
    ('a1d764df-9b5c-4f62-b0a1-13d8edfcf4a3', 'fddde66f-9b84-4bb8-b408-eae5b815ae69', '654 Birch Blvd', 'Novi Sad', 'Robert', 'Martin', '+1 305-555-7282'),
    ('6e0c99f4-226f-49fb-bc4b-1f59ff671b95', 'db48e7ac-1d35-4d9d-8e09-bf2e86533b91', '321 Cedar Ln', 'Novi Sad', 'Lily', 'Martinez', '+1 617-555-9865'),
    ('c5e2a004-83b0-4f91-9ff2-c235f2166b72', '8bc76c7b-fc9d-469b-a7b1-2d2291d9a9b6', '543 Pinehill St', 'Niš', 'Samuel', 'Jackson', '+1 512-555-3746');
...
INSERT INTO versioned_service (static_service_id, version, cancellation_deadline, description, is_active, is_available, is_last_version, is_confirmation_manual, is_private, name, price, reservation_deadline, sale_percentage)
VALUES
    -- MUSIC
    ('daa22294-5377-487a-aa3f-7cd5a42cc568', 1, 15, 'A classic jazz band providing smooth live music perfect for cocktail hours or dinner events.', true, true, true, false, false, 'Classic Jazz Band', 890, 20, 0.0),
    ('195eb1c5-6fd6-4139-a697-8cd906219525', 1, 25, 'Solo pianist performing a repertoire of contemporary and classical music for upscale events.', true, true, true, false, false, 'Solo Pianist', 500, 15, 0.03),
    ('c3210396-e7f0-445a-9c26-9b1aec7a3c4a', 1, 19, 'Cover band playing hits from the 80s, 90s, and today for weddings, parties, and corporate events.', true, true, true, false, false, 'Cover Band', 130, 20, 0.04),
    ('e30780b8-b7a8-4737-ae5e-cd11a9ad29fa', 1, 18, 'Upbeat DJ with a wide selection of genres including EDM, pop, and hip-hop for weddings and parties.', true, true, true, false, false, 'Party DJ', 150, 20, 0.04),
    ('a43f5588-d452-4723-a1a1-f5fae353aaab', 1, 10, 'Acoustic duo providing live folk and indie music, ideal for intimate gatherings.', true, true, true, false, false, 'Acoustic Duo', 600, 12, 0.02),
    ('7e0477b8-ae16-4bd1-9596-e4e4372d8c7e', 1, 30, 'Rock band with high-energy performances, perfect for corporate events or large parties.', true, true, true, false, false, 'Rock Band', 200, 30, 0.07),
    ('3ed7c6fd-155e-48a9-a376-52b9b3b43ad8', 1, 20, 'Solo violinist performing classical pieces for formal events and ceremonies.', true, true, true, false, false, 'Solo Violinist', 400, 18, 0.01),
    ('379624ba-652e-42e2-a7bb-d23a53ac2eed', 1, 14, 'DJ specializing in house and techno music, suitable for nightclubs and high-energy events.', true, true, true, false, false, 'House DJ', 180, 15, 0.06),
    ('f501fea8-7903-4ff0-a3d3-49493282a69e', 1, 16, 'Jazz ensemble with a variety of instruments for high-class receptions and dinner events.', true, true, true, false, false, 'Jazz Ensemble', 120, 25, 0.05),
    ('fe2e0eb8-29fa-448b-aace-8af9ccb101f9', 1, 22, 'Solo guitarist offering a mix of classical and contemporary acoustic guitar for elegant gatherings.', true, true, true, false, false, 'Solo Guitarist', 550, 20, 0.03),

    -- CATERING
    ('deca359b-9bfb-4b6f-bc24-3e509f595da4', 1, 25, 'Elegant plated dinner service for weddings and formal events.', true, true, true, false, false, 'Plated Dinner Service', 200, 15, 0.03),
    ('8ec60ce2-d646-43bf-abf1-01e2d6c5c202', 1, 18, 'Casual BBQ catering, perfect for outdoor events and summer parties.', true, true, true, false, false, 'BBQ Catering', 120, 20, 0.04),
    ('b965d715-d2f9-4471-a7f3-5dfb592cfe3d', 1, 19, 'Breakfast and brunch catering, perfect for morning events and meetings.', true, true, true, false, false, 'Brunch Catering', 110, 20, 0.04),

    -- PHOTOGRAPHY
    ('82828d99-3ed9-4a71-8c91-ecfe040411a5', 1, 15, 'Wedding photography service capturing candid and posed moments throughout the entire day, including pre-ceremony and reception.', true, true, true, false, false, 'Wedding Photography', 250, 20, 0.05),
    ('ef1c7659-9bad-4225-b28e-f4b5c133ecbf', 1, 25, 'Corporate event photography, including keynote speeches, networking sessions, and group photos.', true, true, true, false, false, 'Corporate Event Photography', 150, 15, 0.03),
    ('245cb1b1-336b-4bf3-9b40-73eee616f2de', 1, 18, 'Outdoor portrait photography session, offering a mix of natural lighting and candid poses in scenic locations.', true, true, true, false, false, 'Outdoor Portrait Photography', 600, 20, 0.04),
    ('9447c5d5-3a82-44e2-8fe3-5d836f0eda63', 1, 30, 'Family photography with customized themes and settings for large family gatherings and reunions.', true, true, true, false, false, 'Family Photography', 120, 30, 0.07),
    ('9ee88634-aa10-48d1-b2c4-98556eac1684', 1, 20, 'Event photography for private parties, birthdays, and celebrations, capturing key moments and group shots.', true, true, true, false, false, 'Event Photography', 800, 18, 0.01),
    ('10c348f9-e96c-4073-8704-7012f2daa220', 1, 16, 'Engagement photography with a mix of romantic portraits and candid shots to celebrate the couple.', true, true, true, false, false, 'Engagement Photography', 700, 25, 0.05),
    ('1dfcfba8-1b39-4a38-8ff3-a3ec5b409ca2', 1, 22, 'Newborn and maternity photography to capture beautiful moments for families during pregnancy and the early days of life.', true, true, true, false, false, 'Newborn & Maternity Photography', 900, 20, 0.03),

    -- VIDEOGRAPHY
    ('26f74471-8c03-44a0-b200-8796b351f8aa', 1, 15, 'Full-day wedding videography capturing every moment from preparations to the reception, including drone footage.', true, true, true, false, false, 'Wedding Videography', 300, 20, 0.05),
    ('888f99a9-a0e5-469c-bc21-2d6bd429b777', 1, 25, 'Corporate event videography, covering keynotes, interviews, and networking sessions with professional editing and highlights.', true, true, true, false, false, 'Corporate Event Videography', 180, 15, 0.03),
    ('2c358e12-19f2-4a16-a198-ece7c11f7863', 1, 18, 'Highlight reel video for birthdays and private parties, showcasing the best moments with a cinematic touch.', true, true, true, false, false, 'Event Highlight Videography', 120, 20, 0.04),
    ('8fb67698-2344-4b1d-950e-478c14f477cd', 1, 10, 'Live streaming videography for events, including weddings, conferences, or other occasions, with multi-camera setup.', true, true, true, false, false, 'Live Streaming Videography', 150, 12, 0.02),
    ('f38ad3b7-2b26-4762-9f64-892953ba5207', 1, 22, 'Maternity and baby shower videography, documenting key moments and emotional speeches during the event.', true, true, true, false, false, 'Maternity & Baby Shower Videography', 750, 20, 0.03),

    -- GUEST TRANSPORTATION
    ('8d92004c-ce17-4248-ac60-e0a3750bf083', 1, 15, 'Luxury limousine service for weddings, including red carpet, drinks, and personalized decor.', true, true, true, false, false, 'Wedding Limousine', 150, 20, 0.05),
    ('38db314c-ce21-4f96-a2b5-5a6284b1b7b1', 1, 25, 'Shuttle bus service for corporate events, transporting attendees between venues or from hotels to event sites.', true, true, true, false, false, 'Corporate Shuttle Service', 120, 15, 0.03),
    ('b008b01e-4f96-4233-873e-77617645c371', 1, 18, 'Private car service for VIP guests at events, offering comfortable and discreet transportation in luxury vehicles.', true, true, true, false, false, 'VIP Car Service', 100, 20, 0.04),
    ('f43f3ffe-66cb-431b-a88a-fe1b41dbbf22', 1, 22, 'Helicopter transport service for exclusive events, offering quick and luxurious travel to venues with a scenic view.', true, true, true, false, false, 'Helicopter Transport Service', 500, 20, 0.03),
    ('fb6845b5-78c6-495f-b550-c043c9372dee', 1, 19, 'Luxury van rental for private parties, ensuring that guests are comfortably transported in style between event locations.', true, true, true, false, false, 'Luxury Van Rental', 150, 20, 0.04),

    -- EVENT SECURITY
    ('faa74e7e-797a-44f8-8c80-31c0f7964e78', 1, 15, 'Professional security personnel for weddings, ensuring guest safety and managing crowd control during the event.', true, true, true, false, false, 'Wedding Security', 120, 20, 0.05),
    ('0792d0dd-044d-43df-8031-5f9377522502', 1, 25, 'Event security for corporate conferences and expos, providing entry control, monitoring, and incident response.', true, true, true, false, false, 'Corporate Event Security', 250, 15, 0.0),
    ('9affc3a2-6ad9-4677-ae6f-dcc8c77d878b', 1, 10, 'Crowd management and security for concerts and festivals, ensuring smooth entry, exits, and maintaining order throughout the event.', true, true, true, false, false, 'Concert & Festival Security', 180, 12, 0.02),
    ('a37de399-5404-4afb-b722-07b790f49ecc', 1, 16, 'Security for luxury events and gala dinners, offering discreet yet effective protection for high-profile venues and attendees.', true, true, true, false, false, 'Gala Event Security', 120, 25, 0.05),
    ('9495a42f-fd67-44cf-8de8-1bc4b6df81c1', 1, 19, 'Bouncer services for clubs, bars, and private events, ensuring safety and managing entrance to maintain a secure atmosphere.', true, true, true, false, false, 'Bouncer Security', 900, 20, 0.04),

    -- PENDING SERVICE CATEGORY 1
    ('e98baa49-e3b0-49d9-830f-596b87d8fbfe', 1, 19, 'Pending service 1', true, true, true, false, false, 'Pending service 1', 900, 20, 0.04);
...
VALUES
    ('ea0d1c1b-67fa-4f7e-b00d-78129d742d01', 'Smith Wedding', 'A beautiful wedding ceremony with a reception to follow.', '123 Love St', 'Beograd', '2025-05-15', '15:00', 150, true, 44.8176, 20.4569, 'a8b8d5b9-d1b2-47e1-b5a6-3efac3b6b832', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('2c9f1c4d-1cb5-48f2-8618-78e3be06f27f', 'Techno Beats Night', 'A vibrant night filled with music and lights.', '456 Club Rd', 'Beograd', '2025-06-20', '22:00', 300, true, 44.8176, 20.4569, 'cba94c6d-ef28-4de2-bbe7-0e1a7797d941', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('f00de5a9-8c76-4a87-b2cb-1c0b7bc4c9c7', 'Annual Gala 2025', 'A formal event celebrating corporate milestones.', '789 Grand Ave', 'Novi Sad', '2025-09-10', '19:00', 500, false, 45.2671, 19.8335, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('86ad4f02-5c5c-42e6-b789-3181fa81e8f7', 'Toms Birthday Bash', 'A lively party celebrating Toms big day!', '321 Party Ln', 'Novi Sad', '2025-07-01', '18:30', 100, true, 45.2671, 19.8335, '2a3fbe6a-d495-4090-9e2e-09e2a4043460', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('672cde38-24b6-4c79-bd99-4f58c795ba21', 'Summer Outdoor Festival', 'An outdoor festival featuring live music and food trucks.', 'Park Center', 'Niš', '2025-08-15', '12:00', 2000, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('92bb1a4e-98eb-4a63-ae1c-4195c19ae74e', 'Holiday Gala Dinner', 'An elegant dinner event to celebrate the holiday season.', '456 Elite St', 'Novi Sad', '2025-12-20', '20:00', 200, false, 45.2671, 19.8335, 'd1b237e6-d7a9-4797-b39f-9c2a1fcf93c0', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('38c02a1d-e21c-45f3-a486-518a0071a8e9', 'Susans Engagement Party', 'A joyous celebration of Susans engagement.', '98 Celebration Rd', 'Niš', '2025-04-08', '16:00', 80, true, 44.8176, 20.4569, '17f2e64d-bbbe-4784-8cd9-0d98cbf95ad7', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('e7c6d6b5-dae4-4d59-a6c1-1233fa72f5e1', 'Halloween Costume Party', 'A spooky night of fun, costumes, and music.', '111 Spooky Blvd', 'Novi Sad', '2025-10-31', '20:00', 250, true, 45.2671, 19.8335, '33a8ecb0-81a5-44a0-b07d-028b209ef4fd', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('e23ad6d4-cff6-41ec-bcab-d5674d875e2b', 'Community Barbecue and Fair', 'A family-friendly event with food, games, and entertainment.', 'Central Park', 'Beograd', '2025-07-04', '10:00', 300, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('a927e6d5-8e67-4f7f-a1cd-fb56c7d5e8e9', 'Traditional Religious Ceremony', 'A ceremonial event marking a significant cultural milestone.', 'St. Marys Church', 'Novi Sad', '2025-03-15', '11:00', 150, false, 45.2671, 19.8335, 'b740de8f-7a23-4fbb-a6ae-5b0e7777cd18', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('789de567-1234-4f67-8901-3456789abcd1', 'Winter Wonderland Festival', 'A cozy winter event with warm drinks and music.', 'Snow Park', 'Niš', '2025-12-10', '14:00', 500, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('890de567-4321-5f67-1234-4567890abcde', 'Spring Art Expo', 'An art exhibition showcasing local talent.', 'Gallery Road', 'Niš', '2025-03-30', '10:00', 100, false, 45.2671, 19.8335, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('901de678-9876-6f78-3456-5678901bcdef', 'Jazz Night Out', 'A night of soulful jazz and fine dining.', 'Jazz Club', 'Beograd', '2025-06-25', '19:30', 150, true, 44.8176, 20.4569, 'd1b237e6-d7a9-4797-b39f-9c2a1fcf93c0', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('5678a9bc-12de-4f56-b78a-3456c78def90', 'Kids Science Fair', 'A fun and educational event for kids.', 'Science Center', 'Beograd', '2025-09-20', '10:00', 300, true, 44.8176, 20.4569, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('6789a1de-34bc-5f67-c890-4567e89def12', 'Retro Music Night', 'A nostalgic night of music from the 80s and 90s.', 'Retro Club', 'Niš', '2025-10-05', '21:00', 200, true, 45.2671, 19.8335, 'cba94c6d-ef28-4de2-bbe7-0e1a7797d941', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('7890b2de-45cd-6f78-d901-5678f90ef123', 'Family Movie Night', 'An outdoor movie experience for families.', 'Open Air Cinema', 'Beograd', '2025-08-25', '19:00', 250, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('8901c3ef-56de-7f89-e012-6789f01f2345', 'Craft Beer Festival', 'A festival celebrating local craft beers.', 'Brewery District', 'Novi Sad', '2025-06-10', '15:00', 400, true, 45.2671, 19.8335, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('9012d4f0-67ef-8f90-f123-7890a12f3456', 'Meditation Workshop', 'A relaxing session for mindfulness and meditation.', 'Zen Center', 'Niš', '2025-07-18', '09:00', 50, false, 44.8176, 20.4569, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('a12b3c4d-5678-9abc-def0-123456789abc', 'Spring Carnival', 'A family-friendly carnival with games and food.', 'Central Plaza', 'Beograd', '2025-04-10', '10:00', 300, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('b23c4d5e-6789-abcd-ef01-23456789abcd', 'Wine Tasting Night', 'An evening exploring fine wines.', 'Wine Cellar', 'Novi Sad', '2025-06-15', '18:00', 50, false, 45.2671, 19.8335, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('c34d5e6f-789a-bcde-f012-3456789abcde', 'Charity Fun Run', 'A community event to raise funds for a local charity.', 'Riverside Park', 'Beograd', '2025-05-20', '09:00', 400, true, 44.8176, 20.4569, 'b740de8f-7a23-4fbb-a6ae-5b0e7777cd18', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('d45e6f7a-89ab-cdef-0123-456789abcdef', 'Kids Art Workshop', 'A creative event for children.', 'Art Studio', 'Novi Sad', '2025-07-05', '14:00', 30, true, 45.2671, 19.8335, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('e56f7b8e-9abc-def0-1234-56789abcdefd', 'Beograd Jazz Festival', 'A night of incredible jazz performances.', 'Music Hall', 'Niš', '2025-06-25', '20:00', 600, true, 44.8176, 20.4569, 'cba94c6d-ef28-4de2-bbe7-0e1a7797d941', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('f67a8396-abcd-ef01-2345-6789abcdefbc', 'Cultural Heritage Day', 'A celebration of local history and traditions.', 'Museum District', 'Novi Sad', '2025-08-18', '11:00', 150, true, 45.2671, 19.8335, 'b740de8f-7a23-4fbb-a6ae-5b0e7777cd18', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('f7819b0a-bcde-f012-3456-789abcdeffec', 'Outdoor Movie Screening', 'A family-friendly outdoor movie night.', 'City Park', 'Niš', '2025-07-12', '19:30', 200, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('a89e0bdc-cdef-0123-4567-89abcdef2345', 'Startup Pitch Night', 'An event showcasing innovative startups.', 'Tech Hub', 'Niš', '2025-09-01', '18:00', 100, false, 45.2671, 19.8335, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('49021325-def0-1234-5678-9abcdef12453', 'Fitness Bootcamp', 'An energetic outdoor fitness event.', 'City Stadium', 'Beograd', '2025-05-05', '07:00', 80, true, 44.8176, 20.4569, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('ab349894-9101-4157-b71b-40341c08fed2', 'Niš Tech Expo', 'An exhibition showcasing the latest in technology.', 'Tech Park', 'Niš', '2025-04-22', '10:00', 300, true, 43.3209, 21.8958, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('57787b97-680f-436f-95e4-9690357472e4', 'Niš Jazz Nights', 'A weekend of smooth jazz performances.', 'Jazz Club', 'Niš', '2025-07-15', '20:00', 150, true, 43.3209, 21.8958, 'cba94c6d-ef28-4de2-bbe7-0e1a7797d941', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99'),
    ('f10140e9-3a09-42fa-8522-a702d70a1c77', 'Cultural Heritage Walk', 'A guided tour through historic sites.', 'Downtown', 'Niš', '2025-06-05', '09:00', 100, true, 43.3209, 21.8958, 'b740de8f-7a23-4fbb-a6ae-5b0e7777cd18', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('b10994d1-224f-4f6d-bdd7-86f7fde9df5b', 'Belgrade Marathon', 'An annual marathon through the heart of the city.', 'City Streets', 'Beograd', '2025-05-10', '07:00', 500, true, 44.8176, 20.4569, 'b740de8f-7a23-4fbb-a6ae-5b0e7777cd18', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('56f3c073-2fbc-463d-b3a2-bea9dc536454', 'Startup Meetup', 'An event for entrepreneurs and investors.', 'Innovation Hub', 'Novi Sad', '2025-09-20', '16:00', 200, true, 45.2671, 19.8335, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('9cafdd5d-3099-4591-9187-8d7fa43e34c8', 'Niš Food Festival', 'A celebration of local and international cuisine.', 'Main Square', 'Niš', '2025-08-12', '11:00', 300, true, 43.3209, 21.8958, '15c1de85-50a4-4b60-a5c2-bb349d3173ab', '9c88f9ab-c2c9-4823-bf51-e3e263dcd5b0'),
    ('f6a6fb8b-680b-4a7c-ade2-7185c3b3c280', 'Art in the Park', 'An open-air exhibition of local art.', 'Central Park', 'Novi Sad', '2025-06-30', '12:00', 200, true, 45.2671, 19.8335, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', '47c5fa7c-0d12-48e2-a4ed-9e4f441b383f'),
    ('bcc16eba-53df-42e9-b3cd-5d41bf581d94', 'Book Fair 2025', 'An annual book fair with author signings.', 'Exhibition Center', 'Beograd', '2025-10-10', '10:00', 400, true, 44.8176, 20.4569, 'b740de8f-7a23-4fbb-a6ae-5b0e7777cd18', '1d832a6e-7b3f-4cd4-bc37-fac3e0ef9236'),
    ('379c96eb-7391-48b4-adc3-f07095576d3b', 'Tech Career Fair', 'Connecting job seekers with tech companies.', 'Tech Park', 'Niš', '2025-11-05', '09:00', 250, true, 43.3209, 21.8958, 'f726c1a3-13ea-4c5b-8dbf-30927310cb93', 'b38d716b-4d2a-4fd3-b18c-bfa128f24b99');
